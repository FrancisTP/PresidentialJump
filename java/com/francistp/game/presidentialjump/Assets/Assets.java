...
public class Assets {
    ...
    public static void loadText(GLGame game) {
        ...
        a_lower = new TextureRegion(textSpriteSheet, 311, 91, 29, 29);
        a_upper = new TextureRegion(textSpriteSheet, 45, 55, 29, 38);
        apostrophe = new TextureRegion(textSpriteSheet, 717, 112, 7, 13);
        at = new TextureRegion(textSpriteSheet, 3, 3, 44, 48);
        b_lower = new TextureRegion(textSpriteSheet, 261, 3, 32, 38);
        b_upper = new TextureRegion(textSpriteSheet, 297, 3, 32, 38);
        text_background = new TextureRegion(textSpriteSheet, 275, 124, 1, 1);
        c_lower = new TextureRegion(textSpriteSheet, 465, 87, 29, 29);
        c_upper = new TextureRegion(textSpriteSheet, 135, 3, 35, 38);
        comma = new TextureRegion(textSpriteSheet, 737, 88, 7, 14);
        d_lower = new TextureRegion(textSpriteSheet, 369, 45, 25, 38);
        d_upper = new TextureRegion(textSpriteSheet, 333, 3, 32, 38);
        dollar = new TextureRegion(textSpriteSheet, 78, 45, 25, 45);
        e_lower = new TextureRegion(textSpriteSheet, 78, 94, 25, 29);
        e_upper = new TextureRegion(textSpriteSheet, 369, 3, 32, 38);
        equal = new TextureRegion(textSpriteSheet, 708, 88, 25, 20);
        exclamation_mark = new TextureRegion(textSpriteSheet, 644, 87, 7, 38);
        f_lower = new TextureRegion(textSpriteSheet, 398, 45, 25, 38);
        f_upper = new TextureRegion(textSpriteSheet, 143, 87, 29, 38);
        g_lower = new TextureRegion(textSpriteSheet, 311, 45, 25, 42);
        g_upper = new TextureRegion(textSpriteSheet, 174, 3, 35, 38);
        h_lower = new TextureRegion(textSpriteSheet, 427, 45, 25, 38);
        h_upper = new TextureRegion(textSpriteSheet, 405, 3, 32, 38);
        hyphen = new TextureRegion(textSpriteSheet, 697, 118, 16, 7);
        i_lower = new TextureRegion(textSpriteSheet, 655, 87, 7, 38);
        i_upper = new TextureRegion(textSpriteSheet, 729, 3, 13, 38);
        j_lower = new TextureRegion(textSpriteSheet, 717, 45, 22, 39);
        j_upper = new TextureRegion(textSpriteSheet, 370, 87, 22, 38);
        k_lower = new TextureRegion(textSpriteSheet, 456, 45, 25, 38);
        k_upper = new TextureRegion(textSpriteSheet, 176, 87, 29, 38);
        l_lower = new TextureRegion(textSpriteSheet, 666, 87, 7, 38);
        l_upper = new TextureRegion(textSpriteSheet, 179, 45, 29, 38);
        m_lower = new TextureRegion(textSpriteSheet, 213, 3, 44, 29);
        m_upper = new TextureRegion(textSpriteSheet, 441, 3, 32, 38);
        n_lower = new TextureRegion(textSpriteSheet, 498, 87, 29, 29);
        n_upper = new TextureRegion(textSpriteSheet, 477, 3, 32, 38);
        number_0 = new TextureRegion(textSpriteSheet, 485, 45, 25, 38);
        number_1 = new TextureRegion(textSpriteSheet, 396, 87, 19, 38);
        number_2 = new TextureRegion(textSpriteSheet, 514, 45, 25, 38);
        number_3 = new TextureRegion(textSpriteSheet, 543, 45, 25, 38);
        number_4 = new TextureRegion(textSpriteSheet, 209, 87, 29, 38);
        number_5 = new TextureRegion(textSpriteSheet, 513, 3, 32, 38);
        number_6 = new TextureRegion(textSpriteSheet, 212, 45, 29, 38);
        number_7 = new TextureRegion(textSpriteSheet, 572, 45, 25, 38);
        number_8 = new TextureRegion(textSpriteSheet, 601, 45, 25, 38);
        number_9 = new TextureRegion(textSpriteSheet, 630, 45, 25, 38);
        o_lower = new TextureRegion(textSpriteSheet, 531, 87, 25, 29);
        o_upper = new TextureRegion(textSpriteSheet, 3, 55, 38, 38);
        p_lower = new TextureRegion(textSpriteSheet, 278, 45, 29, 39);
        p_upper = new TextureRegion(textSpriteSheet, 549, 3, 32, 38);
        parenthesis_left = new TextureRegion(textSpriteSheet, 419, 87, 19, 38);
        parenthesis_right = new TextureRegion(textSpriteSheet, 442, 87, 19, 38);
        period = new TextureRegion(textSpriteSheet, 728, 112, 7, 7);
        pound = new TextureRegion(textSpriteSheet, 585, 3, 32, 38);
        q_lower = new TextureRegion(textSpriteSheet, 340, 45, 25, 39);
        q_upper = new TextureRegion(textSpriteSheet, 51, 3, 38, 38);
        question_mark = new TextureRegion(textSpriteSheet, 659, 45, 25, 38);
        r_lower = new TextureRegion(textSpriteSheet, 618, 87, 22, 29);
        r_upper = new TextureRegion(textSpriteSheet, 93, 3, 38, 38);
        s_lower = new TextureRegion(textSpriteSheet, 344, 88, 22, 32);
        s_upper = new TextureRegion(textSpriteSheet, 242, 87, 29, 38);
        semi_colon = new TextureRegion(textSpriteSheet, 697, 85, 7, 29);
        t_lower = new TextureRegion(textSpriteSheet, 677, 87, 16, 35);
        t_upper = new TextureRegion(textSpriteSheet, 621, 3, 32, 38);
        u_lower = new TextureRegion(textSpriteSheet, 560, 87, 25, 29);
        u_upper = new TextureRegion(textSpriteSheet, 245, 45, 29, 38);
        v_lower = new TextureRegion(textSpriteSheet, 42, 97, 32, 22);
        v_upper = new TextureRegion(textSpriteSheet, 657, 3, 32, 38);
        w_lower = new TextureRegion(textSpriteSheet, 3, 97, 35, 25);
        w_upper = new TextureRegion(textSpriteSheet, 693, 3, 32, 38);
        x_lower = new TextureRegion(textSpriteSheet, 275, 88, 32, 32);
        x_upper = new TextureRegion(textSpriteSheet, 107, 45, 32, 38);
        y_lower = new TextureRegion(textSpriteSheet, 688, 45, 25, 36);
        y_upper = new TextureRegion(textSpriteSheet, 107, 87, 32, 38);
        z_lower = new TextureRegion(textSpriteSheet, 589, 87, 25, 32);
        z_upper = new TextureRegion(textSpriteSheet, 143, 45, 32, 38);
    }
