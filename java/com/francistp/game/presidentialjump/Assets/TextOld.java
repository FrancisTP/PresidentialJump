...
public class TextOld {
    ...
    public TextOld(float x, float y, String text, float size, String align) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.align = align;
    ...
    public TextOld(float x, float y, String text, float size, String align, float width) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.align = align;
    ...
    public TextOld(float x, float y, String text, float size, String align, float width, float height) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.align = align;
    ...
    public TextOld(float x, float y, String text, float size, String align, float width, float height, boolean background) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.align = align;
